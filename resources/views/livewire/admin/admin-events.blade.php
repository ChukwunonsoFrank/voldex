        ...
        <div class="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6">
            ...
            <div class="rounded-2xl mb-4 border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                ...
                <div class="p-5 space-y-6 border-t border-gray-100 dark:border-gray-800 sm:p-6">
                    <form wire:submit="createNewEvent()">
                        ...
                        <div class="custom-scrollbar max-w-full overflow-x-auto overflow-y-visible px-5 sm:px-6">
                            <table class="min-w-full">
                                <thead class="border-y border-gray-100 py-3 dark:border-gray-800">
                                    <th class="py-3 pr-5 font-normal whitespace-nowrap sm:pr-6">
                                        <div class="flex items-center">
                                            <p class="text-theme-sm text-gray-500 dark:text-gray-400">Poster Image</p>
                                        </div>
                                    </th>
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                                ...
                                                <div class="flex items-center justify-center">
                                                    <div class="relative">
                                                        ...
                                                        <div x-show="isActionDropdownOpen"
                                                            ...
                                                            <a
                                                                href="{{ route('admin.dashboard.events.details', ['id' => $event['id']]) }}">
                                                            ...
                                                            <form
                                                                wire:submit.prevent="destroyEvent({{ $event['id'] }})">
                                                                <button type="submit"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="text-center py-4 text-theme-sm text-gray-500">
                                                No events found.
                                            </td>
                                        </tr>
                                    @endforelse
