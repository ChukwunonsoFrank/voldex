    ...
    <main>
        ...
        <div class="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6">
            ...
            @if (session()->has('error-message'))
                <div wire:key="error-{{ time() }}" x-data="{ show: true }" x-show="show"
                        ...
                        <div class="custom-scrollbar max-w-full overflow-x-auto overflow-y-visible px-5 sm:px-6">
                            <table class="min-w-full">
                                <thead class="border-y border-gray-100 py-3 dark:border-gray-800">
                                    ...
                                    <th class="px-5 py-3 font-normal whitespace-nowrap sm:px-6">
                                        <div class="flex items-center">
                                            <p class="text-theme-sm text-gray-500 dark:text-gray-400">Percentage</p>
                                        </div>
                                    </th>
                                    <th class="px-5 py-3 font-normal whitespace-nowrap sm:px-6">
                                        <div class="flex items-center">
                                            <p class="text-theme-sm text-gray-500 dark:text-gray-400">Minimum Balance
                                            </p>
                                        </div>
                                    </th>
                                    <th class="px-5 py-3 font-normal whitespace-nowrap sm:px-6">
                                        <div class="flex items-center">
                                            <p class="text-theme-sm text-gray-500 dark:text-gray-400">Created At</p>
                                        </div>
                                    </th>
                                    <th class="px-5 py-3 font-normal whitespace-nowrap sm:px-6">
                                        <div class="flex items-center">
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                    @forelse ($membershipLevels as $membershipLevel)
                                        <tr wire:key="membership-level-{{ $membershipLevel->id }}"
                                            ...
                                            <td class="px-5 py-3 whitespace-nowrap sm:px-6">
                                                <div class="flex items-center">
                                                    <p class="text-theme-sm text-gray-700 dark:text-gray-400">
                                                        {{ $membershipLevel->minimum_balance }}
                                                    </p>
                                                </div>
                                            </td>
                                            <td class="px-5 py-3 whitespace-nowrap sm:px-6">
                                                <div class="flex items-center">
                                                    <p class="text-theme-sm text-gray-700 dark:text-gray-400">
                                                        {{ $membershipLevel->created_at->format('M d, Y') }}
                                                    </p>
                                                </div>
                                            </td>
                                            <td class="px-5 py-3 whitespace-nowrap sm:px-6">
                                                <div class="flex items-center justify-center">
                                                    <div class="relative">
                                                        ...
                                                        <div x-show="isActionDropdownOpen"
                                                            ...
                                                            <a
                                                                href="{{ route('admin.dashboard.membershiplevels.details', ['id' => $membershipLevel->id]) }}">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="text-center py-4 text-theme-sm text-gray-500">
