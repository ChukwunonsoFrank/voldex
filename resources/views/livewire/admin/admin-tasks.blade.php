                    ...
                    <form wire:submit="createNewTask()">
                        <div class="-mx-2.5 flex flex-wrap gap-y-5">
                            ...
                            <div class="w-full px-2.5 xl:w-1/2">
                                ...
                                <input wire:model="cost" type="number" step="0.01" placeholder="Task cost"
                                    class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                                @error('cost')
                                    <p class="mt-1 text-sm text-error-500">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="custom-scrollbar max-w-full overflow-x-auto overflow-y-visible px-5 sm:px-6">
                            <table class="min-w-full">
                                <thead class="border-y border-gray-100 py-3 dark:border-gray-800">
                                    <th class="py-3 pr-5 font-normal whitespace-nowrap sm:pr-6">
                                        <div class="flex items-center">
                                            <p class="text-theme-sm text-gray-500 dark:text-gray-400">Image</p>
                                        </div>
                                    </th>
                                    ...
                                    <th class="px-5 py-3 font-normal whitespace-nowrap sm:px-6">
                                        <div class="flex items-center">
                                            <p class="text-theme-sm text-gray-500 dark:text-gray-400">Cost</p>
                                        </div>
                                    </th>
                                    <th class="px-5 py-3 font-normal whitespace-nowrap sm:px-6">
                                        <div class="flex items-center">
                                            <p class="text-theme-sm text-gray-500 dark:text-gray-400">Level</p>
                                        </div>
                                    </th>
                                    <th class="px-5 py-3 font-normal whitespace-nowrap sm:px-6">
                                        <div class="flex items-center">
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                                ...
                                                <div class="flex items-center justify-center">
                                                    <div class="relative">
                                                        ...
                                                        <div x-show="isActionDropdownOpen"
                                                            ...
                                                            <a
                                                                href="{{ route('admin.dashboard.tasks.details', ['id' => $task->id]) }}">
                                                            ...
                                                            <form
                                                                wire:submit.prevent="destroyTask({{ $task->id }})">
                                                                <button type="submit"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center py-4 text-theme-sm text-gray-500">
                                                No tasks found.
                                            </td>
                                        </tr>
                                    @endforelse
