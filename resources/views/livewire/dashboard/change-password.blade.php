<div x-data>
    ...
    <div id="appCapsule">
        <div class="section mt-2 mb-2">
                    ...
                    <form wire:submit="changePassword">
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <input wire:model="confirm_password" type="password" class="form-control" id="confirm_password">
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
            ...
            <div class="section-title">Update Withdrawal Password</div>
            <div class="card">
                <div class="card-body">
                    <form wire:submit="updateWithdrawalPassword">
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                <label class="label" for="withdrawal_password">Withdrawal Password</label>
                                <input wire:model="withdrawal_password" type="password" class="form-control" id="withdrawal_password">
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
